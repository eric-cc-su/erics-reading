...
def update_index(books_html: str, new_index_filepath: str="src/index_autogenerated.html") -> str:
    """
...
if __name__=="__main__":
    ...
    if len(sys.argv) < 2:
        ...
        if os.path.isfile(filepath):
            new_html = generate_books_html(parse_xml(filepath))
            print(update_index(new_html))
            sys.exit(0)
        else:
